...
def callbackFunction(message):
    try:
        ...
        # Display the count of faces on the image
        cv2.putText(cv_image, f"Faces: {face_count}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)

        # Log the count of detected faces
        rospy.loginfo(f"Number of faces detected: {face_count}")
